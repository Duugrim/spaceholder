...
- См. `legacy/AIMING_SYSTEM_DOCUMENTATION.md` только для справки по старой архитектуре
...
- `AIMING_SYSTEM_README.md` — быстрый старт и программный доступ
- `legacy/AIMING_SYSTEM_DOCUMENTATION.md` — legacy система (только справка)
