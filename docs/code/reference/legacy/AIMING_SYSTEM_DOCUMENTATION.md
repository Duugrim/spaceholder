...
doc-type: reference
status: legacy
note: "Старая AimingSystem/RayCaster; заменена на Payload → ShotManager → DrawManager."
tags:
  - sh-code-doc/reference
  - sh-code-doc/status/legacy
---

# Документация системы прицеливания SpaceHolder (LEGACY)

> **Устарело.** Эта документация описывает систему на базе AimingSystem / RayCaster / RayRenderer, которая отключена с 2025-10-28.  
> **Актуальная архитектура:** см. [SHOOTING_SYSTEM.md](../SHOOTING_SYSTEM.md) и [AIMING_SYSTEM_README.md](../AIMING_SYSTEM_README.md).

---

## Обзор архитектуры (legacy)

Система прицеливания состояла из 5 основных модулей:
