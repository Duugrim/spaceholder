...
5. **PayloadDialog** (`module/helpers/payload-dialog.mjs`)
   ...
   - ✅ Интеграция с Token Controls и AimingSystem

6. **Token Controls Интеграция** (`module/helpers/token-controls.mjs`) ✅
   - ✅ Новый workflow: PayloadDialog → AimingSystem → ShotSystem
   - ✅ Коллбэки для обработки результата прицеливания
   - ✅ Автоматический выстрел после прицеливания

7. **AimingSystem Переработка** (`module/helpers/aiming-system.mjs`) ✅
   - ✅ Убрана логика стрельбы
   - ✅ Оставлен только UI прицеливания
   - ✅ Метод `aim()` возвращает результат прицеливания
...
- [x] **Интеграция с Token Controls** - заменить старое меню прицеливания на PayloadDialog ✅
- [x] **Направление выстрела** - теперь берется из AimingSystem.aim() ✅
- [ ] **Тестирование нового workflow** - протестировать PayloadDialog → AimingSystem → ShotSystem
