...
// Swing - серия конусов с изменяющимися параметрами
// Например, атака мечом с широким размахом
{
  "type": "swing",
  "direction": -45,        // Начинаем с -45° относительно направления
  "range": 2,              // Начальная дальность
  "angle": 30,             // Угол каждого конуса
  "cut": 0,                // Без отсечения
  "directionStep": 15,     // Каждый следующий конус на +15°
  "rangeStep": 0.2,        // Каждый следующий конус дальше на 0.2
  "count": 7,              // Всего 7 конусов (от -45° до +45°)
  "collision": {
    "walls": true,
    "tokens": true
  },
  "props": {},
  "onHit": "next"          // Продолжаем к следующему конусу после попадания
}

// Swing с уменьшающейся дальностью (затухающая атака)
{
  "type": "swing",
  "direction": 0,
  "range": 5,
  "angle": 45,
  "directionStep": 10,
  "rangeStep": -0.5,       // Дальность уменьшается
  "count": 5,
  "collision": {
    "walls": true,
    "tokens": true
