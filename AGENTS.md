...
- `docs/` — техническая документация: `SHOOTING_SYSTEM.md` (стрельба/payload/сегменты), анатомия, влияние, глобальная карта и т.д. **При доработках интерфейса см. `docs/UI_DESIGN_GUIDE.md`** — правила и эталоны дизайна.
